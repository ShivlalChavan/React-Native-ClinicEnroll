                       ...
                       then((response) => {
                        ...
                        const  resData = responseData;
                          ...
                          for(const key in responseData){
                           ...
                           console.log('Size'+patientData[5].isDocumentAdded)    
                        ...
                        const result   = patientData.filter(function(data) {
                           return data.bloodTest === true && data.isDocumentAdded === false;
                     });
...
export const screenOptions = navData => {
    ...
    return {
           headerTitle:'Lab Report Patient',
           headerLeft : () => (
